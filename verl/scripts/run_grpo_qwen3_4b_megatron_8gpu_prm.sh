...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen3-4B-Instruct-2507, 8 GPU) ===================
# Pure PRM reward on ALL responses (correct and incorrect).
# LLM proof grading (3-tier: 0/0.5/1) as direct GRPO reward.
...
# PRM Baseline: LLM proof grading on ALL responses (3-tier reward)
export USE_PRM_REWARD=true
export USE_DUAL_OBJECTIVE=false

# LLM Grader (GPT-OSS-20B, for 3-tier proof grading)
...
echo "=== PRM Baseline: Qwen3-4B-Instruct-2507 Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BInstructPRM
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_prm_baseline_$(date +%Y%m%d_%H%M%S)
