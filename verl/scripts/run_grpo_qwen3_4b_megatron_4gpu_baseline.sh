...
# =================== Baseline: Standard GRPO (Qwen3-4B-Instruct-2507, 4 GPU) ===================
...
echo "=== Baseline: Qwen3-4B-Instruct-2507 Standard GRPO 4GPU with ORM+LLM-fallback ==="
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_4gpu_orm_baseline_$(date +%Y%m%d_%H%M%S)
