...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen2.5-7B-Instruct, 8 GPU) ===================
...
echo "=== PRM Baseline: Qwen2.5-7B-Instruct Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BInstructPRM
