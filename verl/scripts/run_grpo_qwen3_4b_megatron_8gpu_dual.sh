...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen3-4B-Instruct-2507, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen3-4B-Instruct-2507 Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BInstructDual
