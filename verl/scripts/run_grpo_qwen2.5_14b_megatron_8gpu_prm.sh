...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen2.5-14B, 8 GPU) ===================
...
#
# Model: Qwen2.5-14B (no chat template)
...
echo "=== PRM Baseline: Qwen2.5-14B Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen14BPRM
