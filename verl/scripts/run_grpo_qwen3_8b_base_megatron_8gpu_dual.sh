...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen3-8B-Base, 8 GPU) ===================
# Algorithm: A_total = A_out + lambda_eff * A_proc
#   A_out: ORM+LLM-fallback binary rewards (standard GRPO normalization)
#   A_proc: LLM proof grading PRM scores (3-tier: 0/0.5/1.0), normalized among correct responses only
...
echo "=== PA_GRPO: Qwen3-8B-Base Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen8BBaseDual
