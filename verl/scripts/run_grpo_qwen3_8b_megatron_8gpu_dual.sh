...
# =================== PA_GRPO: Dual-Objective GRPO Training (Qwen3-8B, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen3-8B Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen8BDual
