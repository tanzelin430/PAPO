...
# =================== Baseline: Standard GRPO (Qwen2.5-7B-Base, 8 GPU) ===================
...
echo "=== Baseline: Qwen2.5-7B-Base Standard GRPO 8GPU with ORM+LLM-fallback ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BBase
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_orm_baseline_20260302_180941
