...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen2.5-3B, 8 GPU) ===================
...
#
# Model: Qwen2.5-3B (no chat template)
...
echo "=== PRM Baseline: Qwen2.5-3B Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen3BPRM
