...
TRAIN_FILE="/mnt/shared-storage-user/ma4agi-gpu/data/dataset/NuminaMath-1.5-RL-Verifiable/train_verl_format.parquet"
...
# =================== Model Configuration ===================
MODEL_NAME=Qwen3-4B
BASE_MODEL=/mnt/shared-storage-gpfs2/gpfs2-shared-public/huggingface/hub/models--Qwen--Qwen3-4B/snapshots/eb971e9fb1f41c13b5e5a56e56886305c5ad94a0

# =================== Logging Configuration ===================
WANDB_PROJECT=verl_math_rl
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_numina_math_grpo
...
python3 -m verl.trainer.main_ppo \
    ...
    +ray_kwargs.ray_init.object_store_memory=350000000000 \
    "$@"
