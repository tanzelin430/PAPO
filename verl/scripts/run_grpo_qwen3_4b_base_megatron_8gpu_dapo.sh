...
# =================== DAPO Baseline: Standard GRPO + DAPO Length Control (Qwen3-4B-Base, 8 GPU) ===================
# Algorithm: Standard GRPO (A_out only, no A_proc)
...
echo "=== DAPO Baseline: Qwen3-4B-Base GRPO+Overlong 8GPU ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BBaseDAPO
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_dapo_$(date +%Y%m%d_%H%M%S)
