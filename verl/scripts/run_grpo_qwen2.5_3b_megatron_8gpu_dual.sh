...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen2.5-3B, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen2.5-3B Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc, lambda=1.0) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen3BDual
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_dual_objective_20260308_201451
