...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen2.5-7B-Base, 8 GPU) ===================
...
echo "=== PRM Baseline: Qwen2.5-7B-Base Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BBasePRM
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_prm_baseline_20260301_183103
