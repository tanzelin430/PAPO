...
# =================== Baseline: Standard GRPO (Qwen3-4B-Instruct-2507, 8 GPU) ===================
...
echo "=== Baseline: Qwen3-4B-Instruct-2507 Standard GRPO 8GPU with ORM+LLM-fallback ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BInstruct
