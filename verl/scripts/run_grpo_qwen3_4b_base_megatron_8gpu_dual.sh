...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen3-4B-Base, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen3-4B-Base Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BBaseDual
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_dual_objective_20260314_194404
