...
# =================== Baseline: Standard GRPO (Qwen3-4B-Base, 8 GPU) ===================
...
echo "=== Baseline: Qwen3-4B-Base Standard GRPO 8GPU with ORM+LLM-fallback ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BBase
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_orm_baseline_20260314_184734
