...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen2.5-7B-Base, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen2.5-7B-Base Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BBaseDual
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_8gpu_dual_objective_20260301_183206
