...
# =================== Baseline: Standard GRPO (Qwen2.5-7B-Instruct, 8 GPU) ===================
...
echo "=== Baseline: Qwen2.5-7B-Instruct Standard GRPO 8GPU with ORM+LLM-fallback ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BInstruct
