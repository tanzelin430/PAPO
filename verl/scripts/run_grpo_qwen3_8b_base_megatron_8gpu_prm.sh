...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen3-8B-Base, 8 GPU) ===================
# Pure PRM reward on ALL responses (correct and incorrect).
# LLM proof grading (3-tier: 0/0.5/1.0) as direct GRPO reward.
...
echo "=== PRM Baseline: Qwen3-8B-Base Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
