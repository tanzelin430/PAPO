...
# =================== 4-GPU Megatron AOPS Proof Training ===================
# AOPS 5000 proof problems + DeepSeek V3.2 Speciale as LLM-as-Judge
# All rewards are LLM-based (no rule-based fallback)
...
echo "=== AOPS Proof Training: DeepSeek V3.2 Speciale as LLM Judge ==="
...
TRAIN_FILE="${DATA_DIR}/train/aops_5000.parquet"
...
WANDB_EXPERIMENT_NAME=${MODEL_NAME}_megatron_4gpu_aops_dpsk_$(date +%Y%m%d_%H%M%S)
