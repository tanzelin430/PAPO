...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen3-4B-Instruct-2507, 4 GPU) ===================
...
#
# Model: Qwen3-4B-Instruct-2507 (non-thinking, direct answer)
# Parallelism: TP=2, PP=1, DP=2 (4x H200 GPUs)
# Response length: 16384 (for thinking mode long outputs)
...
# LLM Grader (GPT-OSS-20B, for both LLM-fallback and PRM 5-tier scoring)
...
echo "=== PA_GRPO: Qwen3-4B-Instruct-2507 Dual-Objective 4GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BDual
...
val_files="['${EVAL_DIR}/math__math_500.parquet', '${EVAL_DIR}/aime2024.parquet', '${EVAL_DIR}/aime2025.parquet', '${EVAL_DIR}/amc2023.parquet', '${EVAL_DIR}/gpqa_diamond.parquet', '${EVAL_DIR}/olympiad.parquet', '${EVAL_DIR}/logic__zebra_puzzle_dataset_200.parquet']"
