...
# =================== PRM Baseline: Standard GRPO with LLM Proof Grading (Qwen3-4B-Base, 8 GPU) ===================
...
echo "=== PRM Baseline: Qwen3-4B-Base Standard GRPO 8GPU with LLM Proof Grading (3-tier) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen4BPRM
