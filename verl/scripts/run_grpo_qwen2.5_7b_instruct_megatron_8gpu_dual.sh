...
# =================== PA_GRPO: Dual-Objective GRPO (Qwen2.5-7B-Instruct, 8 GPU) ===================
...
echo "=== PA_GRPO: Qwen2.5-7B-Instruct Dual-Objective 8GPU (ORM+LLM for A_out, PRM for A_proc) ==="
...
export WANDB_DIR=${SCRIPT_DIR}/../wandbQwen7BInstructDual
