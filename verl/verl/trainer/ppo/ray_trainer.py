...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self):
        ...
        self.actor_rollout_wg.save_checkpoint(
            actor_local_path, actor_remote_path, self.global_steps, max_ckpt_to_keep=max_actor_ckpt_to_keep, wandb_run_id=wandb_run_id
        )
    ...
    def fit(self):
        ...
        if self.global_steps > 0:
            ...
            if wandb_run_id:
                print(f"Found WandB run ID from checkpoint: {wandb_run_id}")
