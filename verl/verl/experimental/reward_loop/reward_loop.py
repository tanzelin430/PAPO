...
class RewardLoopManager:
    ...
    def compute_rm_score(self, data: DataProto) -> DataProto:
        ...
        reward_extra_keys = sorted(list(reward_extra_keys))  # Convert to sorted list for consistent merging
        non_tensor_batch = {}
        ...
        # Only include reward_extra_keys in meta_info if keys are not empty
        meta_info = {"reward_extra_keys": reward_extra_keys} if len(reward_extra_keys) > 0 else {}
        return DataProto(
